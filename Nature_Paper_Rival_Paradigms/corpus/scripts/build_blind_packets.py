...
def packet_manifest(
    ...
    return {
        ...
        "excluded_by_design": [
            ...
            "corpus/metadata/papers.csv fields for citation counts and prior notes",
        ],
    }
...
def main() -> None:
    ...
    round_manifest = {
        ...
        "packets": packet_rows,
        "skipped": skipped,
        "exclusion_note": "Packets do not include prior scoring files, aggregate files, coding notes, citation counts, or outcome information.",
    }

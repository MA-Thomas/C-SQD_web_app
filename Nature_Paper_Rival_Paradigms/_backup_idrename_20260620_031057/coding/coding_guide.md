...
The Stratum B controls are the weakest part of the pilot by design. Several are plausible
matched papers, but two may be better treated as progress-like papers or downstream theoretical
uptake rather than true controls. This is useful: it reveals that the control-matching rule needs
